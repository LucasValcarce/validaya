...
public class CryptoRSA {
    private SterumPayProperties properties;
    ...
    public  String rsaEncryptionOaepSha256(String plaintextByte) throws GeneralSecurityException {
        return base64Encoding(rsaEncryptionOaepSha256(getPublicKeyFromString(properties.getPublicKey()), plaintextByte.getBytes(StandardCharsets.UTF_8), CipherSuite.RSA));
    }
